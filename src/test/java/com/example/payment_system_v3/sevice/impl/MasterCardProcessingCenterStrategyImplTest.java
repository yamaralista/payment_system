...
class MasterCardProcessingCenterStrategyImplTest {
    @InjectMocks
    ...
    public void testIssueCard() throws InvalidCredentialsException, ClientNotFoundException {
        ...
        masterCardProcessingCenterStrategy.issueCard(cardRequestDto);
    ...
    public void testTopUpCard() throws InvalidPinException, CardNotFoundException {
        ...
        Card card = new Card();
        card.setCardNumber("5234567890123456");
        ...
        masterCardProcessingCenterStrategy.topUpCard(card, amount);
    ...
    public void testDebitCard() throws InvalidPinException, CardNotFoundException {
        ...
        masterCardProcessingCenterStrategy.debitCard(card, amount);
    ...
    public void testDebitCardWithInsufficientBalance() {
        ...
        assertThrows(IllegalArgumentException.class, () -> masterCardProcessingCenterStrategy.debitCard(card, amount));
    ...
    public void testDebitCardWithNonExistentCard() {
        ...
        assertThrows(CardNotFoundException.class, () -> masterCardProcessingCenterStrategy.debitCard(card, amount));
        verify(cardRepository, never()).save(any(Card.class));
    }
}